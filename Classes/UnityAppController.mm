...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    arguments = [arguments arrayByAddingObject:@"-FIRDebugEnabled"];
    [[NSProcessInfo processInfo] setValue:arguments forKey:@"arguments"];	
...
- (void)applicationDidBecomeActive:(UIApplication*)application
{
    ...
    [[IronsourceAdsHelper sharedObject] showResumeAds];
